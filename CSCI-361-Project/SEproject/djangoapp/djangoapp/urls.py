...
urlpatterns = [
    ...
    path('', views.admin_welcome, name="welcome"),
    ...
    path('doctor_page/<int:cid>', LoginView.as_view(template_name='doctor_page.html'), name='doctor_page'),
    path('patients_page/<int:cid>', LoginView.as_view(template_name='patients_page.html'), name='patients_page')
]
